...
## DESCRIPTION
The Set-CIPPRevokeSessions function terminates all active user sessions for a specified user in a given tenant.
...
#### EXAMPLE 1
```powershell
Set-CIPPRevokeSessions -CustomerTenantID "contoso.onmicrosoft.com" -UserID "12345678-1234-1234-1234-123456789012" -UserName "john.doe@contoso.com"
```
#### EXAMPLE 2
```powershell
